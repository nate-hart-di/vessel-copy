...
if (!function_exists('get_header')) die(); //Block direct access
/*
						...
						<div <?php post_class(); ?>>
						    ...
						    <?php do_action('di_content_bookends', get_the_ID(), 'top' );
						        ...
						        <div class="sharing">
						            ...
						            <a trid="b7160bac901941f59d7de8" trc href="javascript:void(0);" onclick="popupwindow('https://www.facebook.com/sharer/sharer.php?s=100&p[url]=<?php echo get_permalink(); ?>&p[title]=<?php echo urlencode(get_the_title()); ?>','Share on Facebook',940,500); clicky.log(this.href);" class="fa fa-facebook button primary-button facebook"></a>

						            <a trid="994df8c4f6974e71b8061e" trc href="javascript:void(0);" onclick="popupwindow('https://twitter.com/share?text=Check%20out%20this%20post%20<?php echo urlencode(get_the_title()); ?>&url=<?php echo get_permalink(); ?>','Share on Twitter',600,250);clicky.log(this.href);" class="fa fa-twitter button primary-button twitter" ></a>
						            ...
						            <a trid="e802a30c3f914d7d993a75" trc href="javascript:void(0);" onclick="popupwindow('https://www.linkedin.com/shareArticle?mini=true&url=<?= get_permalink(); ?>&title=<?= get_the_title(); ?>', '<?php do_action('blog_after_share'); ?>','Share on LinkedIn',600,350); clicky.log(this.href);" class="fa fa-linkedin button primary-button linkedin"></a>
						            <?php endif; ?>
									...
									if( have_rows('upsells') ): ?>
										<div class="swiper-container upsell-container">
											<div class="swiper-wrapper upsells">
	    									    ...
	    									    while ( have_rows('upsells') ) : the_row(); ?>

	    									        <a trid="8f5ce9607ba146829f8289" trc class="swiper-slide upsell-item" href="<?php the_sub_field( 'link' ); ?>" target="_<?php the_sub_field( 'target' ); ?>">
	                                                    <?php
	                                                    ...
	                                                    ?>
	                                                    <span>
	                                                        <img src="<?php echo $imgsrc; ?>" alt="<?php echo $image['alt']; ?>">
	                                                    </span>
