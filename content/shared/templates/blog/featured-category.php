    ...
    <div class="container-wide">
        ...
        <div class="featuredCats hidden-xs">
            <div class="featuredCats__wrapper">
                <div class="hidden-xs">
                    <a trid="89751b0d409249c9b5c6a6" trc class="featuredCategory <?php //echo $this->is_active('blog'); ?> " href="/blog/" alt="View all posts">Home</a>
                    <?php 
        ...
        <?php // featured categories as a dropdown, used on mobile only ?>
