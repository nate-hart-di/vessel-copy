     ...
     if (is_single()) { ?>
	        ...
	        <div class="sharing">
	           <?= __('Share this Post:', 'commontheme') ?>
				...
				<?php
       /** FB sharer no longer accepts custom parameters. Info here: https://developers.facebook.com/support/bugs/357750474364812/ */
       ?>
	            ...
	            <a trid="d014811c15c94a93965b3d" trc href="javascript:void(0);" onclick="popupwindow('https://twitter.com/share?text=Check%20out%20this%20post%20<?php echo urlencode(
               get_the_title(),
	            ...
	            <a trid="1bcc601737ce45328a57d1" trc href="javascript:void(0);" onclick="popupwindow('https://www.linkedin.com/shareArticle?mini=true&url=<?= get_permalink() ?>&title=<?= get_the_title() ?>', '<?php do_action(
  'blog_after_share',
