...
<div id="coupon-<?php echo $id; ?>" class="coupon-coupon difo-list-item <?php echo $type;?>">
    <div class="inner">
        <div class="container-fluid">
            <div class="row">
				<?php echo get_namespaced_template_part( '__difo_global_partials', 'partial', 'coupon-head-list', array( 'coupon_vars' => $coupon_vars ) ); ?>
                <?php echo get_namespaced_template_part( '__difo_global_partials', 'partial', 'coupon-content-list', array( 'coupon_vars' => $coupon_vars ) ); ?>
            </div>
        </div>
    </div>
