    ...
    <div class="container">
        ...
        <div class="row">
            <div class="social" data-testid="social">
                <?php get_scoped_template_part('partials/social/links', 'iconfont', array( 'sorting' => 'facebook,twitter,instagram,youtube-play' ) ); ?>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="footer-middle">
                ...
                <div class="mobile-menu">
                    ...
                    <span class="di-version hidden-xs">
                        Advanced Automotive Dealer Websites by <a trid="5f0cb128fdee4b1ab54202" trc href="http://www.dealerinspire.com" target="_blank">Dealer&nbsp;Inspire</a> <?php echo (defined('ENVIRONMENT') && constant('ENVIRONMENT') != 'production') ? constant('DI_VERSION') : ''; ?>
                    </span>
                </div>
