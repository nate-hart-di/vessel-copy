                        ...
                        <ul id="menu-top-menu" class="nav">
                            ...
                            foreach($items as $i => $menu_item) {
                                ...
                                <?php if($menu_item->menu_item_parent == 0) : ?>
                                    <li class="menu-item"><a trid="581f2873f0f646fc8b76dd" trc <?php if($class == '' || in_array("hide-submenu", $menu_item->classes)) : ?>href="<?= $menu_item->url ?>"<?php endif; ?> target="<?php echo $link_target;?>" ><?php echo str_replace(" Vehicles", "", $menu_item->title); ?></a>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="dealer-address">
                            <a trid="3ec90bfd3e424f6d96f257" trc target="_blank" itemprop="directions" href="<?php echo get_option('di_google_map'); ?>"><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo get_option('di_street_address'); ?> • <?php echo get_option('di_city'); ?>, <?php echo get_option('di_state'); ?> <?php echo get_option('di_zipcode'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <span>
                        <?php 
                            ...
                            if( !empty( $openTodayText ) ){
                                ...
                                echo $hours['open']['time'] ?> AM-<?php echo $hours['close']['time'] ?><?php echo $hours['close']['meridiem'];
                            } ?>
                    </span>
                </div>
                <?php
