        ...
        <div class="header-top">
            <div class="logo" itemscope itemtype="http://schema.org/Organization">
                <a trid="cce6acfe80cb48abbed20d" trc itemprop="url" href="<?php echo home_url(); ?>">
                    <?php if (!get_field('vessel_header_image', 'option')): ?>
                        <img itemprop="logo" data-original="<?php echo get_stylesheet_directory_uri(); ?>/images/logo-head.png" alt="<?php echo get_bloginfo('title'); ?>">
                    <?php endif; ?>
                    <?php if (get_field('vessel_header_image', 'option')): ?>
                        <img id="vessel-header-img" data-original="<?= get_field('vessel_header_image', 'option'); ?>" alt="Custom Header Image">
                    <?php endif; ?>
                </a>
            </div>
            <div id="main-navbar" class="navbar flex">
                <div class="navbar-inner">
                    <div class="nav_section">
                        <?php if((get_field( 'rotating-logos', $pg ) == 'Yes') && (get_field( 'rotating-logos-header', $pg ) == 'Yes')) : ?>
                        ...
                        <ul id="menu-top-menu" class="nav">
                            ...
                            foreach($items as $i => $menu_item) {
                                ...
                                <?php if($menu_item->menu_item_parent == 0) : ?>
                                    <li class="menu-item"><a trid='f6f1c112a8704817981413' trc <?php if($class == '' || in_array("hide-submenu", $menu_item->classes)) : ?>href="<?= $menu_item->url ?>"<?php endif; ?>><?php echo str_replace(" Vehicles", "", $menu_item->title); ?></a>
            ...
            <div class="search-anything-toggle">
                ...
                <?php get_scoped_template_part('partials/search/anything', '', isset($anything)?$anything:array()); ?>
                    ...
                    <button trid="c94fcb3990fa4499b18027" trc type="submit" class="btn search-anything-submit-btn" data-gtm-event="mobileSearchOverlaySearchBtn"> <?php get_template_part('includes/svg/icon','search'); ?></button>
                </form>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="dealer-phone">
                            <span class="phone"><i class="fa fa-phone" aria-hidden="true"></i> Sales: <span id="phonenumber_sales"><?php echo do_shortcode('[di_phone option_key="sales" format="withparens" clickable="true"]'); ?></span></span> |
                    ...
                    <div class="col-sm-4">
                        <div class="dealer-address">
                            <a trid="8d760de177b44d97af00ee" trc target="_blank" itemprop="directions" href="<?php echo get_option('di_google_map'); ?>"><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo get_option('di_street_address'); ?> • <?php echo get_option('di_city'); ?>, <?php echo get_option('di_state'); ?> <?php echo get_option('di_zipcode'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mobile-header-top">
			...
			<span class="logo" itemscope itemtype="http://schema.org/Organization">
				<a trid="ce4077657e534429858ac9" trc itemprop="url" href="<?php echo home_url(); ?>" data-gtm-event="mobileHeaderLogo">
					<img itemprop="logo" data-original="<?php echo '/wp-content/plugins/vessel/content/dealers/' . get_option('di_slug') . '/images/logo-head-mobile.png' ?>" alt="<?php echo get_bloginfo('title'); ?>">
				</a>
                <?php if (get_field('vessel_header_image', 'option')): ?>
            ...
            <div class="icons">
                <span class="menu-hours hidden-xs">
                  <a trid="d25cb2f1a8d948c891fca7" trc class="hours-icon" target="_blank" href="<?php echo get_option('di_google_map'); ?>">
