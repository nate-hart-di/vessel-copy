<div class="visible-xs">
    <div class="mobile-cta" style="position: relative;display: block;">
        ...
        ?>
            <div class="ctaItem di-lazyloaded">
                <img class="ctaItem-image" src="<?= $ctaImage['sizes']['thumbnail']; ?>" data-lazy-img="<?= $ctaImage['sizes']['large']; ?>" alt="<?= $ctaImage['alt']; ?>" height="<?= $ctaImage['height']; ?>" />
        ...
        <?php else : ?>
            <div class="ctaItem">
                ...
                <img class="ctaItem-image" data-original="<?= $ctaImage['sizes']['large']; ?>" alt="<?= $ctaImage['alt']; ?>" height="<?= $ctaImage['height']; ?>" />
                <?php endif; ?>
    ...
    <div id="mobile-subscribe" data-acf="mobile_email_form">
        <?php 
            //echo do_shortcode('[gravityform id="153" title="false" description="true"]');
