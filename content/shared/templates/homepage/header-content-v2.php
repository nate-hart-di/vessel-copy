    ...
    <div id="header" class="menu-top">
        ...
        <div class="header-top">
            <div class="logo" itemscope itemtype="http://schema.org/Organization">
                ...
                <?php else: ?>
                <a trid="e1e7c51f55c14536ac6e4b" trc itemprop="url" href="<?php echo home_url(); ?>"><img itemprop="logo" src="<?php echo '/wp-content/plugins/vessel/content/dealers/' . get_option('di_slug') . '/images/logo-head.png'  ?>" alt="<?php echo get_bloginfo('title'); ?>"></a>
                <?php endif; ?>
                        ...
                        <ul id="menu-top-menu" class="nav">
                            ...
                            foreach($items as $i => $menu_item) {
                                ...
                                <?php if($menu_item->menu_item_parent == 0) : ?>
                                    <li class="menu-item"><a trid="46c8da80e8a14c7db05558" trc <?php if($class == '' || in_array("hide-submenu", $menu_item->classes)) : ?>href="<?= $menu_item->url ?>"<?php endif; ?>><?php echo str_replace(" Vehicles", "", $menu_item->title); ?></a>
                ...
                <div class="row">
                    <div class="col-sm-4 no-padding">
                        <div class="dealer-phone">
                            <span class="phone"><i class="fa fa-phone" aria-hidden="true"></i> Sales: <?php echo do_shortcode('[di_phone option_key="sales" format="withparens" clickable="true"]'); ?> </span> |
                            <span class="phone"> Service: <?php echo do_shortcode('[di_phone option_key="service" format="withparens" clickable="true"]'); ?> </span>
                        </div>
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-4 no-padding">
                        <div class="dealer-address">
                            <a trid="83969b06021c4291b226db" trc target="_blank" itemprop="directions" href="<?php echo get_option('di_google_map'); ?>"><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo get_option('di_street_address'); ?> • <?php echo get_option('di_city'); ?>, <?php echo get_option('di_state'); ?> <?php echo get_option('di_zipcode'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
