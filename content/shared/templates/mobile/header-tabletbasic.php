...
<div id="tablet-basic-header" class="menu-top">
  ...
  'title',
    ...
    <?php endif; ?>
            ...
            <ul>
                <li>
                    ...
                    <a trid="4e7ccd5c8177406d98f5e4" trc href="<?php echo $phone_link; ?>" data-gtm-event="tabletHeaderPhone">
                      ...
                      ?>
                        <a trid="c2ab08d9cc0746b0b9c80f" trc data-phone="Sales" itemprop="phone" href="tel:<?php echo str_replace(
                          [' ', '-', '(', ')', '.'],
                          '',
                          $phone,
                        ); ?>" rel="nofollow" data-gtm-event="tabletHeaderPhone">
                            <?php } ?>
                            <span class="glyphicon glyphicon-earphone" aria-hidden="true"></span><span class="text"><?php echo get_option(
                              'di_phone',
                            ); ?></span>
                        </a>
                </li>
                <li>
                    ...
                    <a trid="ace78e8c54df4531b6eec8" trc href="<?php echo $map_link; ?>" data-gtm-event="tabletHeaderDirections">
                        <?php } else { ?>
                        <a trid="ba138d1cc7254bb6adbfbe" trc target="_blank" itemprop="directions" href="<?php echo get_option(
                          'di_google_map',
                        ); ?>" data-gtm-event="tabletHeaderDirections">
                            <?php } ?>
        ...
        ob_start();
        if (
          class_exists('DIContactAtOnce') &&
          DIContactAtOnce::get()->is_enabled() &&
          DIContactAtOnce::get()->is_placement_set('mobile')
        ): ?>
