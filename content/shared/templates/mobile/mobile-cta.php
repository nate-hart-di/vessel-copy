		...
		<div class="mobile-cta_wrap">
			...
			?>
				<div class="ctaItem">
					...
					<a trid="4025d70633c541e9802b1c" trc <?php if ($ctaClass) { ?> href="#" <?php } else { ?> href="<?php echo $ctaLink; ?>" <?php }; ?> <?php echo $new_window ?> class="button dark-button <?php if ($ctaClass) : echo $ctaClass; endif ?>" style="background-color:<?= $ctaLinkBG; ?>;color:<?= $ctaLinkColor; ?>"><?= $ctaLinkTitle; ?></a>
				</div>
			<?php endwhile; endif;  ?>
		</div>
	<?php endwhile; endif; ?>
