...
<div id="header" class="menu-top hidden-sm hidden-xs">
    <div class="header-top">
        <div class="dealer-phone">
            <span class="phone">Sales: <span id="phonenumber_sales"><?php echo do_shortcode('[di_phone option_key="sales" format="withparens" clickable="true"]'); ?></span></span> | 
        ...
        <div class="dealer-address">
            ...
            <a trid="d6fecd72a4a04b69b048cf" trc target="_blank" itemprop="directions" href="<?php echo get_option('di_google_map'); ?>"><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo get_option('di_street_address'); ?> • <?php echo get_option('di_city'); ?>, <?php echo get_option('di_state'); ?> <?php echo get_option('di_zipcode'); ?></a>
    ...
    <div class="header-bottom">
        <div class="logo" itemscope itemtype="http://schema.org/Organization">
            ...
            <?php else: ?>
            <a trid="5f26ddd5024548a1ba5377" trc itemprop="url" href="<?php echo home_url(); ?>"><img itemprop="logo" src="<?php echo '/wp-content/plugins/vessel/content/dealers/' . get_option('di_slug') . '/images/logo-head.png'  ?>" alt="<?php echo get_bloginfo('title'); ?>"></a>
            <?php endif; ?>
            <?php if (get_field('vessel_header_image', 'option') && get_field('vessel_header_image_link', 'option')): ?>
                <a trid="e07b03621e0543fd98b9e7" trc href="<?php echo get_field('vessel_header_image_link', 'option'); ?>">
            ...
            <div class="navbar-inner">
                <div class="nav_section">
                    <?php
                     ...
                     if((get_field( 'rotating-logos', $pg ) == 'Yes') && (get_field( 'rotating-logos-header', $pg ) == 'Yes')) : ?>
                        <ul id="menu-top-menu-2" class="nav logo-swap">
                            <li class="menu-item rotating-logos" id="rotating-logos">
                                <a trid="4f92df08234447ce901801" trc class="menu-item-img">
                                    <?php
                                    $rotatingenable = '';
                                    if((get_field( 'amg-logo-header', $pg ) == true) && (get_field( 'sprinter-logo-header', $pg ) == true)) {
                    ...
                    <ul id="menu-top-menu" class="nav">
                        ...
                        foreach($items as $i => $menu_item) {
                            ...
                            <?php if($menu_item->menu_item_parent == 0) : ?>
                                <li class="menu-item"><a trid="77bf2b05c11a4c919869a8" trc <?php if($class == '' || in_array("hide-submenu", $menu_item->classes)) : ?>href="<?= $menu_item->url ?>"<?php endif; ?> <?php if( !empty($target) ) : echo 'target='.$target; endif;?> ><?php echo str_replace(" Vehicles", "", $menu_item->title); ?></a>
        ...
        <div class="search-anything-toggle">
            ...
            <?php get_scoped_template_part('partials/search/anything', '', isset($anything)?$anything:array()); ?>
                ...
                <button trid="e6789600daab42c8bef6a6" trc type="submit" class="btn search-anything-submit-btn" data-gtm-event="mobileSearchOverlaySearchBtn"> <?php get_template_part('includes/svg/icon','search'); ?></button>
            </form>
        </div>
    </div>
</div>
...
<div id="algolia-overlay" class="hidden-all">
    <div class="search-field">
        <?php
        if ( !is_plugin_active( 'maven-algolia/maven-algolia.php' ) )  {
            ?>
            <form action="/" id="searchform" data-testid="searchform" role="search" method="get">
                <?php get_template_part('includes/svg/icon','search'); ?>
                <?php
                echo do_shortcode('[search_inventory name="search" id="search-anything-field" /]');
                ?>
...
<?php if(has_action('fj_below_homepage_video') || get_field('search_usp')) { ?>
    <div id="usp-overlay" class="hidden-all">
        <?php
        if(has_action('fj_below_homepage_video')) {
    ...
    <div class="menu-top <?php echo $showtitle ? ' with-labels' : ''; ?>">
        <div class="mobile-header-top">
            ...
            <div class="deviceWrapper__menu menu-hamburger open-overlay-js header-toggle-js" target="fullmenu">
                <span class="active">
                    <?php get_scoped_template_part('includes/svg/icon-menu', '', array('height' => '25px', 'width' => '25px')) ?>
                </span>
			...
			<span class="logo" itemscope itemtype="http://schema.org/Organization">
                <a trid="302be5fae56d4e08bc2951" trc itemprop="url" href="<?php echo home_url(); ?>" data-gtm-event="mobileHeaderLogo">
                    ...
                    <?php endif; ?>
                    <?php if (get_field('vessel_header_image', 'option') && get_field('vessel_header_image_link', 'option')): ?>
                        <a trid="309bed9b7bd14a8081a2e8" trc href="<?php echo get_field('vessel_header_image_link', 'option'); ?>">
                            <img id="vessel-header-img" src="<?= get_field('vessel_header_image', 'option'); ?>" alt="Custom Header Image">
                        </a>
                    <?php elseif (get_field('vessel_header_image', 'option')): ?>
                        <img id="vessel-header-img" src="<?= get_field('vessel_header_image', 'option'); ?>" alt="Custom Header Image">
            ...
            <div class="icons">
                <span class="menu-hours hidden-xs">
                  <a trid="56b81c7a1582417681c128" trc class="hours-icon" target="_blank" href="<?php echo get_option('di_google_map'); ?>">
                    <?php get_scoped_template_part('includes/svg/icon-map-marker', '', array('height' => '24px', 'width' => '24px')) ?>
                  </a>
                </span>
                ...
                <span class="menu-search">
					<a trid="35fe31560cd1434db6c97a" trc class="overlay-toogle" data-toggle-target="#algolia-overlay" data-gtm="desktop.homepage.btn.buy">
                        <?php get_scoped_template_part('includes/svg/icon-search', '', array('height' => '24px', 'width' => '24px')) ?>
					</a>
				</span>
                ...
                <span class="menu-phone">
					<a trid="13707f20c1f644a496e3d7" trc class="overlay-toogle" data-toggle-target="#contact-overlay" data-gtm-event="mobileHeaderPhone">
						<?php get_scoped_template_part('includes/svg/icon-phone', '', array('height' => '24px', 'width' => '24px')) ?>
					</a>
				</span>
                ...
                <div class="wrapper visible-xs visible-sm">
                    <div class="device-nav-menu">
                        <div id="close-button" class="close">
                            <?php get_scoped_template_part('includes/svg/icon-close', '', array('height' => '25px', 'width' => '25px')) ?>
                        </div>
                        <div class="navbar">
                            <div class="navbar-inner">
                                <?php
                                    ...
                                    <div class="overlay" id="menu-submenu-overlay">
                                        <div trid="c86cb26c0d804eb0b5e8f4" trc class="back-button">
                                            <div class="back" id="back-button">
                                              <?php get_scoped_template_part('includes/svg/icon-chevron-left', '', array('height' => '30px', 'width' => '30px')) ?>
                                            </div>
