...
<div id="header" class="visible-header">
    <div class="header-top hidden-sm hidden-xs">
        <div class="dealer-phone">
            ...
            ); ?></span></span> <span class="header-btw-phones"> | </span>
        ...
        <div class="dealer-address">
            <?php do_action('before_fj_header_v2_address'); ?>
                <a trid="790354c61f754846befab4" trc target="_blank" itemprop="directions" href="<?php echo get_option(
                  'di_google_map',
   ...
   'di_zipcode',
    ...
    <div class="header-bottom">
                ...
                <a trid="4a97fd36e9184d47844a2c" trc itemprop="url" href="<?php echo home_url(); ?>" data-gtm-event="mobileHeaderLogo" class="fj-navbar-brand">
                    ...
                    <?php if (
                      ...
                      get_field('vessel_header_image_link', 'option')
                        ...
                        <a trid="02ccb29836414020abfe69" trc href="<?php echo get_field(
        ...
        <div class="header-right">
            <a trid="c7ec0978c0894632bb578a" trc class="store-locator" target="_blank" href="<?php echo get_option(
              'di_google_map',
