...
// ********************* START -> NEW HEADER MENU 03/2024 **************************************
    ...
    $('ul.dropdown-menu li.dropdown a,ul.dropdown-menu li.dropdown ul.dropdown-menu li.dropdown a').append('<span class="caret"></span>');
...
// *************************************************************************************************
    ...
    var homeBtn = '<a trid="c80c4279970d4c67bc8b6b" trc href="/blog" class="back-button button primary-button small" id="me">Home</a>'
  ...
  $(".open-overlay-js").click(function(e) {
    if ($('#full-overlay').hasClass("open")) {
        ...
        if (!$('#' + $(this).attr('target') + "-overlay").hasClass('showTarget')) {
          ...
          $('#' + $(this).attr('target') + "-overlay").show().addClass("showTarget");
          $('body').css('overflow-y', 'hidden');


        } else {
          // close the overlay & target 
          $('#' + $(this).attr('target') + "-overlay").hide().removeClass("showTarget");
