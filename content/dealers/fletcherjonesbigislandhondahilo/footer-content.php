  ...
  <div class="container-wide">
    <div class="row">
      ...
      <div class="col-sm-3 footer-left hidden-xs">
        <a trid="4fdabf31790b481297674e" trc href="<?php echo get_bloginfo(
          'url',
        ); ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/footer-left-logo.png" alt="<?php echo get_bloginfo(
  'title',
); ?>" /></a>
      </div>
      ...
      <div class="col-sm-6 footer-middle">
        ...
        <span class="di-version">
          Advanced Automotive Dealer Websites by <a trid="ffb5281b552d411c85d2bc" trc href="http://www.dealerinspire.com" target="_blank">Dealer&nbsp;Inspire</a> <?php echo defined(
            'ENVIRONMENT',
      ...
      <div class="col-sm-3 footer-right hidden-xs">
        <a trid="d207c7d44c6947bc9d9ec7" trc href="<?php echo get_bloginfo(
          'url',
