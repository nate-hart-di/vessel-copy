jQuery(document).ready(function ($) {
    ...
    $('body').on('vrp-ready vrp-ajax-complete', function () {
      ...
      if ($(document).width() < 768 && $('.show-filters-button').length === 0) {
        ...
        $(sort)
          ...
          .append(
            "<a trid='2204beadc9474e2bb19ca3' trc class='button primary-button show-filters-button align-left' style='margin:0'>Filter Results</a>",
          )
          .find('select')
          .css({ width: '40%' });
  ...
  jQuery('body').on('vrp-ready vrp-ajax-complete', function () {
    jQuery('.vehicle').each(function (index, element) {
      ...
      jQuery(this)
        .find('.button-bar .button-bar-item a.lease-for-less')
        .insertAfter(jQuery(this).find('.vehicle-price .price-leaseandfinance'));
      ...
      jQuery(this)
        .find('.vehicle-price .price-leaseandfinance .price-block, .vehicle-price .price-leaseandfinance .leaseoffer')
