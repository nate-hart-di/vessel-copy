<footer id="footer" class="footerRow">
	...
	<section class="footerBottom">
		<div class="container-wide">
            <a trid="047e5f97f30e4acdb7bbfa" trc class="link__logo" href="<?php echo home_url(); ?>">
			...
			<div class="infoWrapper">
				...
				<div class="infoWrapper__di">
					<?= __("Advanced Automotive Dealer Websites by", "dealertheme"); ?>
					<a trid="b435fe368b054041b7420c" trc href="https://www.dealerinspire.com" target="_blank">Dealer&nbsp;Inspire</a>
				</div>
			</div>
            <a trid="7fda4362ea1642e49b7cdb" trc class="button email-button text-center hidden-xs" type="button" href="/email-us/">Sign Up for Email Updates</a>
		</div>
	</section>
