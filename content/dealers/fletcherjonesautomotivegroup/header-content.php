<div class="hidden-sm hidden-xs">
        ...
        <div class="header-top">
            <div class="logo" itemscope itemtype="http://schema.org/Organization">
                <a trid="9b442ce997754573b9c18a" trc itemprop="url" href="<?php echo home_url(); ?>">
                    <img itemprop="logo" data-original="<?php if (get_field('vessel_main_logo', 'options')) {
                      $image = get_field('vessel_main_logo', 'options');
                      echo $image['url'];
                    } else {
                      echo '/wp-content/plugins/vessel/content/dealers/' .
                        get_option('di_slug') .
                            ...
                            foreach ($items as $i => $menu_item) {
                              $class = $menu_item->classes['0']; ?>
                                <?php if ($menu_item->menu_item_parent == 0): ?>
                                    <li class="menu-item"><a trid="448273214c0b46a091f812" trc <?php if (
                                      $class == '' ||
  ...
  $menu_item->title,
                ...
                <?php if (get_field('header_nav_image', 'option')): ?>
                    <a trid="3e87b18b59c848ed91c0fc" trc href="<?php echo get_field(
                      'header_nav_image_link',
                      'option',
                    ); ?>"><img id="vessel-header-img" data-original="<?= get_field('header_nav_image', 'option')[
  'url'
] ?>" alt="Custom Header Image"></a>
                <?php endif; ?>
...
<div class="visible-sm visible-xs">
  <div id="tablet-mobile-header">
		...
		<div class="logo" itemscope itemtype="http://schema.org/Organization">
			<a trid="40e851dc8e24431ebc1876" trc itemprop="url" href="<?php echo home_url(); ?>"><img itemprop="logo" id="main-logo" class="hidden-xs" src="<?php echo get_stylesheet_directory_uri(); ?>/images/logo.png" alt="<?php echo get_bloginfo(
  'title',
); ?>"><img itemprop="logo" class="hidden-sm" id="main-logo" src="<?php echo get_stylesheet_directory_uri(); ?>/images/logo-head-mobile.png" alt="<?php echo get_bloginfo(
  'title',
); ?>"></a>
		</div>
...
<?php get_scoped_template_part('partials/navigations/offcanvas', 'nav', [
  'flyout_id' => 'sidr-desktop-content',
