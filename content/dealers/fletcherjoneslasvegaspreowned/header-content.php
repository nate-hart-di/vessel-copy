        ...
        <div class="header-top">
            ...
            <div class="search-anything-toggle">
                <form action="/" id="searchform" data-testid="searchform" role="search" method="get">
                    ...
                    ?>
                    <button trid="1dd96ab44fd2447491f5b6" trc type="submit" class="btn search-anything-submit-btn" data-gtm-event="mobileSearchOverlaySearchBtn"> <?php get_template_part('includes/svg/icon','search'); ?></button>
                </form>
            </div>
        </div>
        ...
        <div class="header-bottom">
            ...
            <div class="header-bottom__right">
                <div class="dealer-address">
                    <a trid="16d1f8e36e2a40068bf437" trc target="_blank" itemprop="directions" href="<?php echo get_option('di_google_map'); ?>"><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo get_option('di_street_address'); ?> • <?php echo get_option('di_city'); ?>, <?php echo get_option('di_state'); ?> <?php echo get_option('di_zipcode'); ?></a>
                </div>
...
<div id="contact-overlay" class="hidden-all">
    ...
    <div>
        ...
        <span class="sales-phone">
            <span class="department">Sales:</span> <?php echo do_shortcode('[di_phone option_key="sales" format="withparens" clickable="true" classes="phone"]'); ?>
        </span>
        <span class="service-phone">
            <span class="department">Service:</span> <?php echo do_shortcode('[di_phone option_key="service" format="withparens" clickable="true" classes="phone"]'); ?>
        </span>
    </div>
</div>
        ...
        <?php foreach(array('Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','Sunday') as $day){
            ...
            if(!empty($hours))
            {
                ...
                <div class="department-hours">
                    <span><?php echo $day ?>: </span><span><?php echo $hours['open']['time'] ?> AM-<?php echo $hours['close']['time'] ?><?php echo $hours['close']['meridiem'] ?></span>
                </div>
                <?php
            }
            else
        ...
        <div class="mobile-header-top">
			...
			<span class="logo" itemscope itemtype="http://schema.org/Organization">
				<a trid="8d4ea5c1364743489996bf" trc itemprop="url" href="<?php echo home_url(); ?>" data-gtm-event="mobileHeaderLogo">
					<img itemprop="logo" src="<?php echo '/wp-content/plugins/vessel/content/dealers/' . get_option('di_slug') . '/images/logo-head-mobile.png' ?>" alt="<?php echo get_bloginfo('title'); ?>">
				</a>
                <?php if (get_field('vessel_header_image', 'option')): ?>
                    <img id="vessel-header-img" src="<?= get_field('vessel_header_image', 'option'); ?>" alt="Custom Header Image">
                <?php endif; ?>
            ...
            <div class="icons">
                <span class="menu-hours hidden-xs">
                  <a trid="7f7c7f9ef81343d0aa819d" trc class="hours-icon" target="_blank" href="<?php echo get_option('di_google_map'); ?>">
                ...
                <span class="menu-phone">
        			...
        			?>
        			<a trid="f08fa8b0755643fab0f17f" trc data-phone="Sales" itemprop="phone" data-toggle-target="#contact-overlay" href="tel:<?php echo str_replace(array(" ","-","(",")","."),"",$phone); ?>" rel="nofollow">
