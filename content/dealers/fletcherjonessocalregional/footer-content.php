<footer id="footer" class="footerRow">
	...
	<section class="footerBottom">
		<div class="container-wide">
            <a trid="f40b2d68684141a1a3630e" trc class="link__logo" href="<?php echo home_url(); ?>">
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/logo.png?ver=<?php echo filemtime(
  get_stylesheet_directory() . '/images/logo.png',
       ...
       'dealertheme',
     ) ?> <a trid="1777b7b5c043403abeedb9" trc href="https://www.dealerinspire.com" target="_blank">Dealer&nbsp;Inspire</a>
				</div>
			</div>
