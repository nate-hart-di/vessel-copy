    ...
    <div class="header-bottom">
        <div class="header-left">
        	<div class="logo" itemscope itemtype="http://schema.org/Organization">
        		<a trid="3fdb241caf8f4382a4a411" trc itemprop="url" href="<?php echo home_url(); ?>"><img itemprop="logo" src="<?php echo get_stylesheet_directory_uri(); ?>/images/logo.png?ver=<?php echo filemtime( get_stylesheet_directory().'/images/logo.png');?>" alt="<?php echo get_bloginfo('title'); ?>"></a>
                        ...
                        <div class="nav_section">
                            <ul id="menu-top-menu" class="nav">
                                ...
                                foreach($items as $i => $menu_item) {
                                    ...
                                    $link = '';
                                    $additionalClasses = '';                        
                                    $label = $menu_item->attr_title != '' ? str_replace(" Vehicles", "", $menu_item->attr_title) : str_replace(" Vehicles", "", $menu_item->title);
                                        ...
                                        <div class="header-dropdown-container">
                                            ...
                                            <div class="menu-image-sidebar">
                                                ...
                                                <a trid="be9f2f90dc2b4a48bef4b2" trc href="<?php echo $menuadlink; ?>">
                                                    <img src="<?php echo $menuad['url']; ?>" alt="<?php echo $menuad['alt']; ?>" />
                                                </a>
