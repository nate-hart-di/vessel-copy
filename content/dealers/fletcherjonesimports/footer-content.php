<footer id="footer" class="footerRow">
	...
	<section class="footerBottom">
		<div class="container-wide">
            <a trid="6426729afd3f445aa1ff53" trc class="link__logo" href="<?php echo home_url(); ?>">
			...
			<div class="infoWrapper">
				...
				<div class="infoWrapper__di">
					<?= __("Advanced Automotive Dealer Websites by", "dealertheme"); ?> <a trid="e95432bfef7f48e3b5ee70" trc href="https://www.dealerinspire.com" target="_blank">Dealer&nbsp;Inspire</a>
				</div>
			</div>
            <a trid="03d199d2adbd4082a5ed1c" trc class="button email-button text-center hidden-xs" type="button" href="/email-us/">Sign Up for Email Updates</a>
		</div>
	</section>
