		...
		<div class="row">
            <div class="col-sm-12 give-way">
                ...
                <span class="copyright">
					Copyright &copy; <?php echo date('Y'); ?> <?php echo get_bloginfo('name'); ?><br />Advanced Automotive Dealer Websites by <a trid="bfb5f14d8a5340868817af" trc href="http://www.dealerinspire.com" target="_blank">Dealer&nbsp;Inspire</a>
				</span>
			</div>
		</div>
	</div>
    ...
    <div class="container-wide">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12 give-way">
                ...
                <?php wp_nav_menu( $defaults ); ?>
                <span class="copyright">
					Copyright &copy; <?php echo date('Y'); ?> <?php echo get_bloginfo('name'); ?><br />Advanced Automotive Dealer Websites by <a trid="1eade55af0794d45816c49" trc href="http://www.dealerinspire.com" target="_blank">Dealer&nbsp;Inspire</a>
				</span>
            </div>
        </div>
    </div>
