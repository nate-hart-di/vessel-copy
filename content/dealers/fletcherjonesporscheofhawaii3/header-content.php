  		...
  		<div class="row">
  			...
  			<div class="col-sm-6">
  				<span class="dealer-address">
  					<a trid="9b72518c6e9241d583447e" trc target="_blank" itemprop="directions" href="<?php echo get_option('di_google_map'); ?>" data-gtm-event="desktopHeaderMapLink">
  						<span class="addressfocus"><span class="glyphicon glyphicon-map-marker"></span> <?php echo get_option('di_street_address'); ?> • <?php echo get_option('di_city'); ?>, <?php echo get_option('di_state'); ?> <?php echo get_option('di_zipcode'); ?></span>
  					</a>
  				</span>
  			</div>
  		</div>
			...
			<div class="row">
				...
				<div class="col-sm-6 no-padding">
					<div class="logo" itemscope itemtype="http://schema.org/Organization">
						<a trid="d0ee25dab1f545dab3a6a0" trc itemprop="url" href="<?php echo home_url(); ?>"><img itemprop="logo" src="/wp-content/plugins/vessel/content/dealers/fletcherjonesporscheofhawaii/images/logo.jpg" alt="<?php echo get_bloginfo('title'); ?>"></a>
					</div>
				</div>
				<div class="col-sm-3">
  				...
  				<?php else: ?>
  					<span>
					    Sales: <?php echo date('D'); ?> <?php echo do_shortcode('[di_display_open_hours departments="Sales" class=dynamic-hours]'); ?>
  					</span>
					  <span>
					    Service: <?php echo date('D'); ?> <?php echo do_shortcode('[di_display_open_hours departments="Service" class=dynamic-hours]'); ?>
					  </span>
					<?php endif ?>
					</div>
				</div>
