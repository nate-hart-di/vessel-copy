...
function vrp_options_cta()
{
  ...
  $html =
    '<div trid="faecdbf602bb445cb9fb11" trc class="button primary-button block options-button" data-toggle="modal" data-target="#DIModal" data-modal-content="#vrp-vehicle-packages-' .
    $vehicle['vin'] .
    '" data-modal-title="' .
    $vehicle['title'] .
