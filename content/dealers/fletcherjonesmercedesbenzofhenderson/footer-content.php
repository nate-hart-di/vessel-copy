<footer id="footer" class="footerRow">
	...
	<section class="footerBottom">
		<div class="container-wide">
            <a trid="b42ef3688115446abfc5ea" trc class="link__logo" href="<?php echo home_url(); ?>">
			...
			<div class="infoWrapper">
				...
				<div class="infoWrapper__di">
					<?= __("Advanced Automotive Dealer Websites by", "dealertheme"); ?> <a trid="295b933ecca24ef9839c4e" trc href="https://www.dealerinspire.com" target="_blank">Dealer&nbsp;Inspire</a>
				</div>
			</div>
            <a trid="5f62a4cf8c7247f6a6682d" trc class="button email-button text-center hidden-xs" type="button" href="/email-us/">Sign Up for Email Updates</a>
		</div>
	</section>
