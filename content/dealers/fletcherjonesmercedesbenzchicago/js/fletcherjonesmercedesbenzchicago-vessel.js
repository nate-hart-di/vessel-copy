...
*/
    ...
    $('body').on('vrp-ready vrp-ajax-complete', function () {
      ...
      if (window.outerWidth < 768 && $('.show-filters-button').length === 0) {
        ...
        $(sort)
          ...
          .append(
            "<a trid='c6dc6cf3382442beba649f' trc class='button primary-button show-filters-button align-left' style='margin:0'>Filter Results</a>",
          )
          .find('select')
          .css({ width: '40%' });
  ...
  jQuery(function () {
    ...
    $('.mobile-tab-content-inside .callus .phone').wrap(
      '<a trid="1ac59902cd44490ea134b9" trc data-phone="Sales" href="tel:312-281-7856"></a>',
    );
    $(
      '<div style="height: 1px; margin-top: 10px; margin-bottom: 15px; background-color: #ccc;"></div><span class="mobile-service"><p class="mobile-service-title">Service Department</p><div class="callus"><p><span class="glyphicon glyphicon-earphone" aria-hidden="true"></span><span class="phone"><a trid="ffaa7d82998d42e0bffdba" trc data-phone="Service" href="tel:773-993-1514">(773)-993-1514</a></span></p></div></span><div class="findus"><p><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span> <span class="address">949 North Elston Avenue, Suite 2 • Chicago, IL, 60642</span></p><a trid="7fd1b8a42cbb4217a93c4a" trc target="_blank" itemprop="directions" href="' +
        serviceDirections +
        '" class="button primary-button">Get Directions</a></div>',
    ).appendTo($('.mobile-tab-content-inside .findus'));
  ...
  if ($('body').hasClass('page-id-16139')) {
    ...
    $.each(addresses, function (address) {
      var newAddress =
        '<strong>Mercedes-Benz of Chicago</strong><br>949 North Elston Avenue, Suite 2 Chicago, IL, 60642 <br>Service: (312) 614-1217';
  ...
  $('body').on('mapbox_loaded_map3', function (e, map, nodeName) {
    ...
    var coordinates = [
      [
        41.8995044,
        -87.6565204,
        '/wp-content/themes/DealerInspireDealerTheme/images/map-marker.png',
      ],
