...
add_action('header_after_logo', function(){
    ?>
        <?php if (get_field('vessel_header_image', 'option') && get_field('vessel_header_image_link', 'option')): ?>
                <a trid="654417994ee44662b0f00c" trc href="<?php echo get_field('vessel_header_image_link', 'option'); ?>">
                    <img id="vessel-header-img" src="<?php echo get_field('vessel_header_image', 'option'); ?>" alt="Custom Header Image">
                </a>
...
// INCLUDES
include_once(WP_CONTENT_DIR . '/themes/DealerInspireCommonTheme/includes/oem/toyota/toyotaexample2/section-cta-acfs.php');
include_once(WP_CONTENT_DIR . '/themes/DealerInspireCommonTheme/includes/oem/toyota/toyotaexample2/section-service-acfs.php');
...
?>
    <a trid="7822f382008a4bc2b6f1a8" trc href="<?php echo home_url(); ?>" class="logo__dealer--imageMobile visible-sm visible-xs">
        <picture>
            <img
                src="<?php echo get_stylesheet_directory_uri(); ?>/images/logo-header.png?ver=<?php echo filemtime( get_stylesheet_directory().'/images/logo-header.png');?>"
