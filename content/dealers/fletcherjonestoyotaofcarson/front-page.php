...
<main id="main-content">
    ...
    <section  class="blockSection contentRow">
        ...
        <div class="container-wide bottomWrapper">
            <div class="row contentOuter">
			    <div class="ctaCarousel swiper-container">
				    <div class="swiper-wrapper">
                        <?php
                            if( have_rows('content9_row')):
                            $count = 1;

                            while ( have_rows('content9_row')): the_row();
            ...
            <div class="blockSection__cta bottomWrapper__buttonWrap">
			    <a trid="e6a19ffbb5da448ea43af9" trc href="<?php the_field('content9_link_url'); ?>" class="button primary-button" <?php if (get_field('open_in_new_tab') == True) { ?> target="_blank" <?php } ?>><?php the_field('content9_link_text'); ?></a>
		    </div>
        </div>
    </section>
    ...
    <section id="serviceRow" class="serviceRow blockSection">
        <div class="container-wide">
            ...
            <h3 class="blockSection__sub"><?php echo get_field('service_subheader') ?: 'Our trained staff can fix or repair your car and get you back on the road. ' ?></h3>
            ...
            <div class="serviceRow__imageWrap">
                <div class="serviceRow__imageWrap--1 lazy-background hidden-sm hidden-xs" style="background-image: url('<?php
                    // Checking for ACF, then DT image, then defaults to AWS image if others do not exist
                    if (get_field("service_row_image")) : echo get_field("service_image_1"); elseif (file_exists(DI_ROOT . '/dealer-inspire/wp-content/themes/DealerInspireDealerTheme/images/bg-service-1.jpg')) : echo get_stylesheet_directory_uri(); ?>/images/bg-service-1.jpg<?php else : echo "https://dealerinspire-shared-assets.s3.amazonaws.com/public/oem/toyota/template2/bg-service-1.jpg"; endif;
                ?>');">
                </div>
                <div class="serviceRow__imageWrap--1 lazy-background visible-sm visible-xs" style="background-image: url('<?php
                    // Checking for ACF, then DT image, then defaults to AWS image if others do not exist
                    if (get_field("service_row_image")) : echo get_field("service_image_1"); elseif (file_exists(DI_ROOT . '/dealer-inspire/wp-content/themes/DealerInspireDealerTheme/images/bg-service-1-mobile.jpg')) : echo get_stylesheet_directory_uri(); ?>/images/bg-service-1-mobile.jpg<?php else : echo "https://dealerinspire-shared-assets.s3.amazonaws.com/public/oem/toyota/template2/bg-service-1.jpg"; endif;
                ?>');">
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12 col-sm-6">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="box small">
                                        <a trid="31f204b848a54de98fdac1" trc href="<?= the_field('first_cta_button_link'); ?>" class="" data-is_cta="<?= the_field('first_cta_is_cta'); ?>">
                                            <div class="box__image">
                                                <picture>
                                                    <source
                                                        media="(max-width: 767px)"
                                                        srcset="<?php echo $cta_1_image_mobile ? $cta_1_image_mobile['sizes']['smallBB'] : $cta_1_image['sizes']['mediumBB']; ?> 767w">
                                                    <img
                                                        src="<?php echo $cta_1_image['sizes']['mediumBB']; ?>"
                                                        alt="<?php // No alt text - image is decorative ?>"
                                                        loading="lazy"
                                                        width="670"
                                                        height="250" />
                                                </picture>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="box wide">
                                <a trid="3d7d779102824ae1bc7765" trc href="<?= the_field('third_cta_button_link'); ?>" class="" data-is_cta="<?= the_field('third_cta_is_cta'); ?>">
                                                <?= the_field('third_cta_button_title'); ?>
                                    <div class="box__image">
                                        <picture>
                                            <source
                                                media="(max-width: 767px)"
                                                srcset="<?php echo $cta_3_image_mobile ? $cta_3_image_mobile['sizes']['mediumBB'] : $cta_3_image['sizes']['mediumBB']; ?> 767w">
                                            <img
                ...
                <div class="col-sm-12 col-sm-6">
                    <div class="box big">
                        <a trid="a428aad5818241eb9f1a63" trc href="<?= the_field('fourth_cta_button_link'); ?>" class="" data-is_cta="<?= the_field('fourth_cta_is_cta'); ?>">
                                        <?= the_field('fourth_cta_button_title'); ?>
                            <div class="box__image">
                                <picture>
                                    <source
                                        media="(max-width: 767px)"
                                        srcset="<?php echo $cta_4_image_mobile ? $cta_4_image_mobile['sizes']['mediumBB'] : $cta_4_image['sizes']['mediumBB']; ?> 767w">
                                    <img
