...
class FJAutoGravity
{
  ...
  public function add_all_ag_hooks()
  {
    ...
    add_action('wp_enqueue_scripts', [$this, 'fj_ag_scripts']);
    ...
    add_action('get_vehicle_array', [$this, 'add_autogravity_json_to_vehicle_array'], 10, 1);
    add_filter('vdp_shopping_tools', [$this, 'inject'], 10, 1);
    add_action('hotwheels_below_cta_box', [$this, 'vdp_placement'], 10, 1);
  }
  ...
  public function fj_ag_scripts()
  {
    wp_register_script(
      'fjautogravity',
      plugins_url() . '/vessel/content/shared/autogravity/autogravity.js',
      ['jquery'],
      null,
      true,
    );
    wp_enqueue_script('fjautogravity', null, ['jquery'], null, true);
  }
  ...
  public function inject($shopping_tools)
  {
    ...
    $this->_tool_data['data']['autogravity'] = isset($vehicle['autogravity_json'])
      ? $vehicle['autogravity_json']
      : false;
