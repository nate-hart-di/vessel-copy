...
class Send extends API
{
    ...
    public function vessel_send_api_settings_hooks() {
        add_action('wp_ajax_nopriv_send_settings', array($this, 'send_settings'));
    }
            ...
            'settings' => array(
                'feature_button' => array(
                    ...
                    'link' => ($button_link !== '') ? $button_link
                        :
                        ($fj_array[$di_id]['feature_button_default'] === '' ? '/current-offers/' : $fj_array[$di_id]['feature_button_default']),
