...
<div class="wrap">
	...
	<h2 class="nav-tab-wrapper">
		<a href="<?php echo add_query_arg('tab', 'general'); ?>" class="nav-tab <?php echo $active_tab == 'general' ? 'nav-tab-active' : ''; ?>"><?php _e('General'); ?></a>
	</h2>
	...
	<div class="tab-container">
		...
		<form id="settings-select" method="post" action="">
            <div>
                <input class="countdown" type="checkbox" id="countdown" name="countdown" value="true" <?php echo ($admin->is_true('homepage-countdown-enabled') ? 'checked' : '') ?>>
