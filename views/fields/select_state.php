<?php if (!class_exists('DealerInspire_Vessel')) die(); //Block Direct Access ?>
<select <?php echo array_key_exists('class', $setting) ? 'class="'.$setting['class'].'"' : '' ?> name="<?php echo $prefix.$id; ?>" id="<?php echo $prefix.$id; ?>">
